...
import { getCategoriesColumns } from "../component/category-columns";
import { Box, CircularProgress, Paper, Typography } from "@mui/material";
import { PostAdd, RestaurantMenu } from "@mui/icons-material";
import { DataGrid } from "@mui/x-data-grid";
import { useNavigate } from "react-router-dom";
import { deleteCategory, editCategory } from "../services/category";
import { DeleteDialogCategory } from "../component/Dialog_delete";
import dataGridStyles from "../../../components/Data-grid-sx"
import { EditDialogCategory } from "../component/Dialog_Edit";
...
const Categories = () => {
    ...
    const { rows, loading, deleteLocal, refresh }   = useCategories(token);
    ...
    const handleDialogSave = async (formData) => {
        ...
        try {
          setLoadingEdit(true);
          await editCategory(token, selectedRow.id, form);
          handleDialogClose();
          await refresh();
        } catch (error) {
